    ...
    >
      ...
      >
        ...
        <p className="text-center text-sm text-gray-500 mb-4">
          {step === 'phone' ? "We'll send a code to your number" : 'Type the 6-digit code we sent you'}
        </p>
        {statusMsg && (
          <div className="text-center mb-4 text-sm font-medium text-[#e80808] min-h-[22px]">{statusMsg}</div>
        )}
        {step === 'phone' && (
          <>
        ...
        >
          {loading ? (step === 'phone' ? 'Sending...' : 'Verifying...') : (step === 'phone' ? 'Send Code' : 'Verify OTP')}
        </button>
      </motion.div>
    </div>
  );
